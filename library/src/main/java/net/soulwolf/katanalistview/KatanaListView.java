 ...
 */
public class KatanaListView extends ListView implements OnScrollListener, KatanaView, View.OnClickListener {
    ...
    public KatanaListView(Context context) {
        this(context, null);
    }

    public KatanaListView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public KatanaListView(Context context, AttributeSet attrs, int defStyle) {
